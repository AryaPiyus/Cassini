      ...
      <div className="flex flex-col justify-center items-center min-h-[calc(100vh-4rem)] px-4">
        <div className="text-center max-w-4xl">
          ...
          <p className="text-xl text-gray-300 mb-8 leading-relaxed">
            Your code repository platform. Store, manage, and collaborate on your projects 
            with powerful version control and seamless deployment.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-800 p-6 rounded-lg">
              ...
              <p className="text-gray-300">
                Track changes, manage commits, and maintain project history with our intuitive CLI.
              </p>
            </div>
            <div className="bg-gray-800 p-6 rounded-lg">
              <h3 className="text-xl font-semibold text-white mb-4">Secure Storage</h3>
              <p className="text-gray-300">
                Your code is safely stored in the cloud with enterprise-grade security.
              </p>
            </div>
            <div className="bg-gray-800 p-6 rounded-lg">
              <h3 className="text-xl font-semibold text-white mb-4">Easy Collaboration</h3>
              <p className="text-gray-300">
